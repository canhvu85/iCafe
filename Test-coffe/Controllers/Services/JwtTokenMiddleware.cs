        ...
        public async Task Invoke(HttpContext httpContext, ITokenBuilder tokenBuilder)
        {
            if (httpContext.Request.Path == "/api/CitiesAPI" ||
                ...
                httpContext.Request.Path.StartsWithSegments("/api/mobile/ShopsApi") ||
                 httpContext.Request.Path.StartsWithSegments("/api/mobile/FloorsApi") ||
                httpContext.Request.Path.StartsWithSegments("/api/mobile/UsersApi") ||
                httpContext.Request.Path.StartsWithSegments("/api/mobile/CatalogesAPI") ||
                httpContext.Request.Path.StartsWithSegments("/api/mobile/TablesApi") ||
                httpContext.Request.Path.StartsWithSegments("/api/mobile/ProductsApi") ||
                httpContext.Request.Path.StartsWithSegments("/api/mobile/BillDetailsApi") ||
                httpContext.Request.Path.StartsWithSegments("/api/mobile/BillsApi") ||
